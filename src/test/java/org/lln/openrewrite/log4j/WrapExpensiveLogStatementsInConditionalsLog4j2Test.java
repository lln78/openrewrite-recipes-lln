 ...
 */
package org.lln.openrewrite.log4j;
...
class WrapExpensiveLogStatementsInConditionalsLog4j2Test implements RewriteTest {
    ...
    @CsvSource(textBlock = """
      ...
      """)
    @ParameterizedTest
    void allLogMethodsWithWrap(String method, String level) {
        rewriteRun(
          java(
            """
              import org.apache.logging.log4j.Logger;
    ...
    @Test
    void useLambdaForSimpleMethodCalls() {
        rewriteRun(
          java(
            """
              import org.apache.logging.log4j.Logger;
